...
class StackSpider(scrapy.Spider):
    ...
    def start_requests(self): 
        ...
        urls = [
            "http://stackoverflow.com/questions?page=" + str(pagina) + "&pagesize=15&sort=newest"
        ]
        for url in urls:
...
def setup_periodic_tasks(sender, **kwargs):
	...
	sender.add_periodic_task(10.0, procesar_subir.s(), name='subir cada 20')
